...
public class FlightDetailsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        b.flightNum.setText(getString(R.string.flight_flight) + " " + selected.getFlightNum());
        b.des.setText(getString(R.string.flight_des) + " " + selected.getDestination());
        b.gate.setText(getString(R.string.flight_gate) + " " + selected.getGate());
        b.delay.setText(getString(R.string.flight_delay) + " " + selected.getDelay());
        b.terminal.setText(getString(R.string.flight_ter) + " " + selected.getTerminal());
