...
public class SavedFlightFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        b.savedFlightNum.setText(getString(R.string.flight_flight) + " " + selected.getFlightNum());
        b.savedDes.setText(getString(R.string.flight_des) + " " + selected.getDestination());
        b.savedGate.setText(getString(R.string.flight_gate) + " " + selected.getGate());
        b.savedDelay.setText(getString(R.string.flight_delay) + " " + selected.getDelay());
        b.savedTerminal.setText(getString(R.string.flight_ter) + " " + selected.getTerminal());
